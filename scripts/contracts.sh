...
declare -a contract_names=("happy-red-packet" "bulk-checkout" "splitter" "balance-checker" "pair" "uniswap-v2-router" "multicall" "erc20" "erc721")
declare -a contract_hosted=(false false false false false false false false false)
